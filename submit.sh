...
$SPARK_SUBMIT \
    ...
    --jars lib_managed/jars/org.elasticsearch/elasticsearch-spark_2.10/elasticsearch-spark_2.10-2.3.3.jar,lib/hadoop-pcap-lib-1.2-SNAPSHOT.jar,lib_managed/jars/joda-time/joda-time/joda-time-2.9.1.jar \
    --master $SPARK_MASTER \
    --num-executors 15 \
    --executor-cores 3 \
    --executor-memory 6G \
